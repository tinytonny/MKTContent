[
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"Operation of Rebuild can restore the Virtual Machines to the start state. It is an upgrade or recovery method when the VM instance requires to operate system upgrade or encounters with the failure of software. It can choose to reset to the system of Linux type or Windows type.",
		"id":6,
	...
	},
	{
		...
		"id":43,
		"fun_introduce":"Data in specified time point can be restored at any time based on the feature of snapshot",
		"product_name":"Cloud Disk Service",
		"fun_name":"Support the creation of cloud disk from snapshot"
	},
	{
		"product_type":"Computing and Network",
	...
	},
	{
		...
		"id":46,
		"fun_introduce":"Monitorable period of Cloud Disk Service is expanded. The monitoring period of 1 day, 7 days and 30 days are added",
		"product_name":"Cloud Disk Service",
	...
	{
		"product_type":"Big Data",
		"fun_description":"It can perform conjunctive query for multiple tables and other complex features’ consolidated calculation through SQL language",
		"id":61,
	...
	},
	{
		...
		"id":67,
		"fun_introduce":"The Virtual Machine list’s resource information can be exported with one-click",
		"product_name":"Virtual Machines",
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"When managing a large number of resources, problems of searching resource can always exist. JD Cloud provides you with intimate search feature of Cloud Disk Service. It can perform accurate searches on the name of the Cloud Disk Service and quickly locates the targeted Cloud Disk Service.",
		"id":79,
		"fun_introduce":"Support the accurate search on the Cloud Disk’s name and quickly locate the required resources.",
		"product_name":"Cloud Disk Service",
		"fun_name":"Cloud Disk Service Search"
	},
	{
		"product_type":"Computing and Network",
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"When new purchase of Cloud Disk Service is paid by configuration and resized, the original \"24-hour pre-paid fee\" rule is canceled and adjusted to use first and Pay-As-You-Go. You can create resources only by ensuring that the account balance meets the threshold requirements when placing an order.",
		"id":81,
		...
		"product_name":"Cloud Disk Service",
		"fun_name":"Adjustment of Cloud Disk Service Billing Mode"
	},
	{
		"product_type":"Computing and Network",
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"When purchasing Pay-In-Advance Virtual Machines at the Console, in the link of payment, online payment is supported. At the same time, multiple payment methods, such as coupon, balance and online payment can be chosen to make hybrid payment \n",
		"id":84,
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"When purchasing Pay-In-Advance Cloud Disk at the Console, in the link of payment, online payment is supported. At the same time, multiple payment methods, such as coupon, balance and online payment can be chosen to make hybrid payment. \n",
		"id":85,
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"When purchasing Pay-In-Advance Public IP at the Console, in the link of payment, online payment is supported. At the same time, multiple payment methods, such as coupon, balance and online payment can be chosen to make hybrid payment \n",
		"id":86,
	...
	},
	{
		...
		"fun_description":"Built on the basis of different data centers, the multi-availability zone of JD Cloud is a multi-availability zone which is really and completely isolated from power, network and other physical facilities, and thus can bear the fault at the computer-room level and further improve the high availability and high reliability.",
		"id":95,
		"fun_introduce":"Products, such as Virtual Machines, VPC, Load Balancer and Cloud Disk, support the deployment in different availability zones, which further enhances the high availability.",
		"product_name":"Virtual Machines",
	...
	},
	{
		...
		"id":96,
		"fun_introduce":"Products, such as Virtual Machines, Cloud Database, Load Balancer and Cloud Disk Service, are newly available in Shanghai",
		"product_name":"Virtual Machines",
	...
	},
	{
		...
		"product_name":"CDN",
		"fun_name":"Release of CDN Operating Analysis and Other New Features"
	},
	{
		"product_type":"Management and Support",
		...
		"product_name":"Account Management",
		"fun_name":"Release of Operation Protection Feature"
	},
	{
		"product_type":"Computing and Network",
		...
		"id":108,
		"fun_introduce":"In the marketplace, tri-image, such as LNMP, Discuz and Zhujibao, are released",
		"product_name":"Virtual Machines",
	...
	},
	{
		...
		"id":122,
		"fun_introduce":"Realize the features of pornographic image identification and face recognition by means of interface call",
		"product_name":"Object Storage Service",
	...
	{
		"product_type":"Storage and CDN",
		"fun_description":"Cn-north-1 is deployed with multiple AZs to achieve cross-computer-room disaster tolerance within the same geographical area and provide high-availability service capabilities across AZs",
		"id":127,
		"fun_introduce":"Cn-north-1 is deployed with multiple AZs to achieve cross-computer-room disaster tolerance within the same geographical area and provide high-availability service capabilities across AZs",
		"product_name":"Object Storage Service",
	...
	{
		"product_type":"Database",
		"fun_description":"JCS for MongoDB’s beta is online. It automatically provides instances with three copies and high-availability, supports automatic switching regarding disaster tolerance and supports the features of backup and recovery. The users can apply for the free trial.",
		"id":134,
		"fun_introduce":" JCS for MongoDB’s beta is online. It automatically provides instances with three copies and high-availability and supports automatic switching regarding disaster tolerence",
		"product_name":"JCS for MongoDB",
		"fun_name":"Beta of JCS for MongoDB comes online"
	},
	{
		"product_type":"Database",
		"fun_description":"JCS for MongoDB provides the feature of cross-availability-zone deployment. It supports to deploy MongoDB's master-slave & hidden nodes in different availability zones to provide machine-room-level disaster tolerance \n",
		"id":135,
		"fun_introduce":"JCS for MongoDB provides the feature of cross-availability-zone deployment and support to deploy MongoDB's master-slave nodes and",
		"product_name":"JCS for MongoDB",
		"fun_name":"JCS for MongoDB supports cross-availability-zone department"
	},
	{
		"product_type":"Database",
		"fun_description":"JCS for MongoDB provides services in the region of cn-east-2 and supports two availability zones - A and B. \n",
		"id":136,
		"fun_introduce":"JCS for MongoDB provides services in the region of cn-east-2 and supports two availability zones - A and B.",
		"product_name":"JCS for MongoDB",
		"fun_name":"Cn-east-2 Area of JCS for MongoDB"
	},
	{
		"product_type":"Database",
		...
		"id":137,
		"fun_introduce":"JCS for MongoDB supports smooth expansion/reduction. The process of changing configuration does not affect service’s operations. Users can adjust instance’s configuration in time according to business conditions.",
		"product_name":"JCS for MongoDB",
		"fun_name":"JCS for MongoDB supports expansion/reduction"
	},
	{
		"product_type":"Database",
	...
	},
	{
		...
		"id":139,
		"fun_introduce":"JCS for MongoDB’s beta is online. It has characteristics of high availability, high reliability, high usability and high security.",
		"product_name":"JCS for MongoDB",
		"fun_name":"JCS for MongoDB releases official version"
	},
	{
		"product_type":"Computing and Network",
	...
	{
		"product_type":"Computing and Network",
		"fun_description":"The specified private IP feature aims for the Virtual Machine’s main network-card’s main private IP. When the VM instance Creation, for the address of private IP address, it can choose to be automatically allocated by the system or it can be specified in Number of available IP address in subnet. \n",
		"id":141,
	...
	{
		"product_type":"Cloud Security",
		"fun_description":"Anti-DDoS protection package is a paid product that improves DDoS attack protection capability for users who deploy businesses in JD Cloud. It is convenient to conduct smooth upgrade on the basis of free 2G bandwidth of Anti-DDos Basic according to the requirements of users themselves. Compared with Anti-DDoS Pro, it has characteristics of simple deployment, lower network latency, high access quality guarantee, etc. It currently supports multiple businesses in JD Cloud, such as improvement of anti-DDoS capabilities for virtual machines, load balancer, cloud physical server, and Web application firewall.",
		"id":2050,
		"fun_introduce":"Open Beta Test of Anti-DDoS Protection Package",
		"product_name":"Anti-DDoS Protection Package",
		"fun_name":"Open Beta Test of Anti-DDoS Protection Package"
	},
	{
		"product_type":"Developer Tools",
		"fun_description":"CodeCommit is the CodeCommit tool implemented by JD Cloud based on Git, facilitating users to commit their codes in JD Cloud. The product includes code commitment, storage, download, fork management, comparison, merger, history and other functions. Users can easily manage items and groups, control permissions. It can seamlessly connect CodeBuild to implement one-stop service from coding to output building results, which is helpful for JD Cloud to continuously deliver the complete process.",
		"id":2051,
		"fun_introduce":"Open Beta Test of CodeCommit",
		"product_name":"CodeCommit",
		"fun_name":"Open Beta Test of CodeCommit"
	},
	{
		"product_type":"Enterprise Application",
		"fun_description":"PLUS smart SMS platform is the opening communication service platform for users provided by JD Cloud. It supports SMS verification code, SMS notification and marketing & promotion SMS. Based on traditional SMS, add the value to text messages through personalized functional menu configuration, connect traditional SP SMS business and intelligent menu so as to provide the customer with one-stop service for SMS sending and promotion of SMS transformation.",
		"id":2052,
		"fun_introduce":"PLUS Smart SMS Formal Release",
		"product_name":"PLUS Smart SMS",
		"fun_name":"PLUS Smart SMS Formal Release"
	},
	{
		"product_type":"Elastic Compute",
		"fun_description":"Generation II high frequency compute virtual machines are put into service, and are applicable to high performance web frontend server, high performance science and engineering application and MMO game, video encoding and the scenarios with more higher requirements to computing capacity.",
		"id":2053,
		"fun_introduce":"Generation II high frequency compute virtual machines are put into service in cn-east-1",
		"product_name":"Virtual Machines",
		"fun_name":"Generation II high frequency compute virtual machines are put into service in cn-east-1"
	},
	{
		"product_type":"Management and Support",
		"fun_description":"According to security requirements of different enterprises, primary account can set enterprise exclusive password policies for sub-users managed by it.",
		"id":2054,
	...
	{
		"product_type":"Management and Support",
		"fun_description":"Users can use default alarm template provided by JD Cloud or customized alarm template created by themselves rapidly create alarm rules for the cloud resources.",
		"id":2056,
	...
	},
	{
		...
		"fun_description":"Customers can view resource overview information of different machine room through console, including cabinets, devices, bandwidth, and public IP information. Customers can view visual view of cabinets and displayed devices in the cabinets through console.",
		"id":2057,
